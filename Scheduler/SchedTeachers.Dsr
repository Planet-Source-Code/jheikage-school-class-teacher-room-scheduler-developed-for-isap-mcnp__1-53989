VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} SchedTeachers 
   Bindings        =   "SchedTeachers.dsx":0000
   Caption         =   "Teacher Schedules"
   ClientHeight    =   7590
   ClientLeft      =   75
   ClientTop       =   360
   ClientWidth     =   9390
   ...
   BeginProperty Section1 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item7 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "TEACHER SCHEDULE"
         CanGrow         =   -1  'True
         Alignment       =   2
      EndProperty
      ItemType8       =   3
   ...
   EndProperty
End
Attribute VB_Name = "SchedTeachers"
