VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} DrepTeachers 
   Bindings        =   "DrepTeachers.dsx":0000
   Caption         =   "Teachers"
   ClientHeight    =   8145
   ClientLeft      =   75
   ClientTop       =   360
   ...
   BeginProperty Section1 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item6 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "LIST OF TEACHERS"
         CanGrow         =   -1  'True
         Alignment       =   2
      EndProperty
      ItemType7       =   3
   ...
   EndProperty
End
Attribute VB_Name = "DrepTeachers"
