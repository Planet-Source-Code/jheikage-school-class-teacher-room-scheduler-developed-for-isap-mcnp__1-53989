...
Begin {C0E45035-5775-11D0-B388-00A0C9055D8E} DE 
   ...
   _ExtentY        =   15081
   FolderFlags     =   1
   TypeLibGuid     =   "{CB1559E6-FBC1-469E-8F67-022E7DB12622}"
   TypeInfoGuid    =   "{6CB32913-342F-4866-90F1-71D595D9C403}"
   TypeInfoCookie  =   0
   Version         =   4
   NumConnections  =   1
   ...
   BeginProperty Recordset2 
      CommandName     =   "ProjProp"
      CommDispId      =   1007
      RsDispId        =   1013
      CommandText     =   $"DE.dsx":00BC
      ActiveConnectionName=   "CON"
      CommandType     =   1
      Expanded        =   -1  'True
      IsRSReturning   =   -1  'True
